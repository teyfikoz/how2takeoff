      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs defaultValue="calculator" className="space-y-6">
          ...
          <TabsContent value="metrics">
            <Card>
              <CardHeader>
                <CardTitle>Key Cargo Metrics & Indicators</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-100 p-4 rounded-md">
                    ...
                    <p className="font-mono text-sm mt-1">Utilization = (Actual Volume / Max Volume) × 100%</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-100 p-4 rounded-md">
                    ...
                    <p className="font-mono text-sm mt-1">FTK = Cargo Weight (tons) × Distance (km)</p>
          ...
          <TabsContent value="formulas">
            <Card>
              <CardHeader>
                <CardTitle>Essential Cargo Calculations</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold">Revenue Calculations</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    ...
                    <div className="bg-gray-100 p-4 rounded-md">
                      ...
                      <div className="font-mono text-sm mt-1 space-y-1">
                        ...
                        <p>Example: ($500,000 / $600,000) × 100% = 83.3%</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold">Fuel Efficiency Metrics</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    <div className="bg-gray-100 p-4 rounded-md">
                      <h4 className="font-semibold">Fuel Burn per Ton-Kilometer</h4>
                      <div className="font-mono text-sm mt-1 space-y-1">
                        <p>FBTK = Total Fuel Burn / Total FTK</p>
                        <p>Example: 120,000 kg / 150,000 = 0.8 kg/ton-km</p>
                      </div>
                    </div>
                    <div className="bg-gray-100 p-4 rounded-md">
          ...
          <TabsContent value="optimization">
            <Card>
              <CardHeader>
                <CardTitle>Cargo Optimization Strategies</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold">ULD Optimization</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold">Dynamic Pricing Strategy</h3>
                  <div className="bg-gray-100 p-4 rounded-md mt-2">
